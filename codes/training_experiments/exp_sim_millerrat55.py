...
config_ranges = { # keys are used to generate model names
      'agent_name': ['MB0s_seed0',
            #'LS0_seed0',
            # 'LS1_seed0', 'MB0_seed0', 'MB1_seed0', 'MB0md_seed0', 'RC_seed0',
                     #'Q(0)_seed0',
                     #'Q(1)_seed0'
                     ],
      'rnn_type': ['GRU'],
...
for n_blocks in [#200,
      ...
      base_config.update({
            'agent_path': ['RTS_agents_millerrat55_nblocks'+str(n_blocks)],
            'input_dim': 3,
            'one_hot': False,
            'exp_folder': get_training_exp_folder_name(__file__)+ '_nblocks'+str(n_blocks),
      })

      config_ranges = { # keys are used to generate model names
            'agent_name': ['Q(0)_seed0'],
            'rnn_type': ['GRU'],
            'hidden_dim': [1,2,3,4],
            'readout_FC': [True],
            'l1_weight': [1e-5],
...
config_ranges = {  # keys are also used to generate model names
      'agent_name': ['MB0s_seed0', 'LS0_seed0', 'LS1_seed0', 'MB0_seed0', 'MB1_seed0', 'MB0md_seed0', 'RC_seed0', 'Q(0)_seed0', 'Q(1)_seed0'],
      'cog_type': [#'BAS',
                   'RC', 'MB0', 'MB0s', 'MB0md', 'MB0m', 'MB1', 'LS0', 'LS1', 'Q(0)','Q(1)'],
}
