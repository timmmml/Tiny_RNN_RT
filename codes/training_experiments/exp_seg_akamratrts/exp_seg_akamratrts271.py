"""
Run all models on Akam's rat (reduced two-step, RTS) 271.
...
base_config = {
      ...
      'dataset': 'AkamRat',
      'behav_format': 'tensor',
      'behav_data_spec': {'animal_name': 271, 'max_segment_length': 150, 'task': 'no_transition_reversal'},
      ### model info
      'agent_type': 'RNN',
...
config_ranges = {  # keys are also used to generate model names
      'cog_type': [
            # 'BAS',
            'MFs',
             'RC', 'MB0', 'MB0s', 'MB0md', 'MB0m', 'MB1', 'Q(0)','Q(1)',
      ],
}
