...
### these are for networks with subject embedding
base_config = {
    ### dataset info
    "dataset": "AkamRat",
    "behav_format": "tensor",
...
### these are for networks without subject embedding
base_config = {
    ### dataset info
    "dataset": "AkamRat",
    "behav_format": "tensor",
...
resource_dict = {"memory": 40, "cpu": 16, "gpu": 0}
# behavior_cv_training_job_combination(base_config, config_ranges, resource_dict)
