"""
Run all models on Akam's rat 264.
Especially the blocks are segmented with 300 trials.
"""
import sys
sys.path.append('..')
...
base_config = {
      ...
      'dataset': 'AkamRat',
      'behav_format': 'tensor',
      'behav_data_spec': {'animal_name': 264, 'max_segment_length': 300},
      ### model info
      'agent_type': 'RNN',
...
resource_dict = {'memory': 18, 'cpu': 16, 'gpu': 0}
