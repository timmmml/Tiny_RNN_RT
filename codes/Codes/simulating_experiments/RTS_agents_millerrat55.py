"""
Run simulations of the RTS agents, with parameters fit to the Miller Rat 55 data.
"""
...
base_config = {
      ...
      'behav_data_spec': {'animal_name': 'm55', 'max_segment_length': 150},
      ### model info
      'agent_type': 'RTSCog',
      'cog_type': 'MB0',
      'device': 'cpu',
      ...
      'inner_fold': 0,
      'seed': 0,
      'exp_folder': 'exp_seg_millerrat55',
}
sim_config = {
      'task': 'Akam_RTS',
...
for n_blocks in [
      ...
      for cog_type in ['MB0s', 'LS0', 'LS1', 'MB0', 'MB1', 'MB0md', 'RC', 'Q(0)', 'Q(1)']:
