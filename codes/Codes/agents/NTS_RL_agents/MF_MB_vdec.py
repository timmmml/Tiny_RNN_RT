...
class MF_MB_vdec(RL_agent):
    'Mixture agent with value forgetting'

    def __init__(self, kernels = ['bs', 'ck', 'rb']):
        self.name = 'MF_MB_vdec'
        self.param_names  = ['alpQ', 'decQ', 'lbd' , 'alpT', 'G_td', 'G_mb']
        self.param_ranges = ['unit', 'unit', 'unit', 'unit', 'pos' , 'pos' ]
    ...
    def session_likelihood(self, session, params_T, get_DVs = False):
        ...
        # Unpack parameters.
        alpQ, decQ, lbd, alpT, G_td, G_mb = params_T[:6]
